        ...
        <!-- footer content -->
                <footer>
                    <div class="no-print">
                        <p class="pull-right">
                            <b>
                                Copyright &copy; KPI by <a>Miqdad Izzudin</a>
        ...
        <!-- daterangepicker -->
        <script type="text/javascript" src="<?= base_url('assets/js/moment.min2.js') ?>"></script>
        ...
        <script src="<?= base_url('assets/js/cropping/main2.js') ?>"></script>
